...
> Auto-generated by `grimoire docs` — 2026-06-28.
...
**Outcome:** Chosen option: "an ordered surface-selection rule", because a written gate is the structural
...
**Outcome:** Chosen option: **shared named-methodology references**, because it is the only option that is
