...
> Auto-generated by `grimoire docs` — 2026-06-21.
...
| security | npm audit | `npm audit --omit=dev` |
| dep_audit | npm audit | `npm audit --omit=dev --audit-level=high` |
...
> As a developer · I want overly verbose comments caught the moment an agent writes them · So that comment quality is enforced at the edit, not left to ignored instructions

- A verbose comment block is rejected at write time
- A comment referencing an external artifact is rejected
- A placeholder stub is rejected
- A pre-existing comment the agent did not touch is left alone
- A whole-file rewrite does not re-flag a kept comment
- A verbose comment inserted via multi-edit is rejected
- An explicit override keeps a justified comment
...
- A trivial change skips the design document
...
|---|----------|--------|------|
| 0001 | Use Gherkin instead of custom WHEN/THEN format | accepted | 2026-04-01 |
| 0002 | Use MADR for architecture decision records | accepted | 2026-04-01 |
| 0003 | Distribute as npm package, not Python CLI | accepted | 2026-04-01 |
| 0004 | Use AGENTS.md as the universal LLM instruction file | accepted | 2026-04-01 |
| 0005 | Use regex-based symbol extraction instead of Tree-sitter | accepted | 2026-04-03 |
| 0006 | Treat config.yaml tool commands as trusted code | accepted | 2026-04-05 |
| 0007 | Use YAML for data schema documentation | accepted | 2026-04-02 |
| 0008 | Use LLM fallbacks for security, secrets, dep_audit, and best_practices checks | accepted | 2026-04-05 |
| 0009 | Use fresh subagents per task section in grimoire-apply | accepted | 2026-04-05 |
...
| 0019 | Conditionally wire review personas by project surface; keep all available | accepted | 2026-05-17 |
| 0020 | `grimoire-design-consult` is a separate skill, not a flag on `grimoire-review` | accepted | 2026-05-17 |
| 0028 | Intent-gated branch-guard via Claude UserPromptSubmit hook | accepted | 2026-05-17 |
| 0029 | Delegate symbol and call-graph intelligence to codebase-memory-mcp | accepted | 2026-05-17 |
| 0031 | Artifact-model redesign: one home per fact, git as history, live-edit on branch | accepted | 2026-06-05 |
...
| 0034 | Living `draft.md` as the single design surface, projected into homes after agreement | proposed | 2026-06-17 |
...
**Outcome:** Chosen option: **ephemeral `draft.md` as the single design surface, projected into the
...
- **add-design-doc-draft-process**: Living draft.md design process for grimoire-draft (draft)
- **harden-autonomous-apply-loop**: Harden the autonomous apply loop (implementing — 17/17 tasks)
